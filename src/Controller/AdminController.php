...
class AdminController extends AbstractController
{
    ...
    public function ajout(Request $request, EntityManagerInterface $manager, SluggerInterface $slugger): Response
    {
        ...
        if ( $form->isSubmitted() && $form->isValid() ) {
            ...
            try{
                ...
                // gerer les exceptions d'ipload image
            }
    ...
    /**
     * @Route("/ajout-usager", name="ajout_usager")
     */
    public function ajoutUsager(Request $request, UsagerRepository $repo)
    {
        $usager = new Usager();
        ...
        return $this->render("admin/formUsager.html.twig", [
            "formUsager" => $form->createView()
        ]);
